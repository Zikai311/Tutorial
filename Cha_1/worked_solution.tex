...
\[
\left(\sum_i c_ir_i\right)\cdot x=\sum_i c_i(r_i\cdot x)=0.
\]
...
Z=u\cdot v
\]
is uniformly distributed on $[-1,1]$, with density $f_Z(z)=\tfrac12$.
...
=\frac12.
\]
Thus the mean absolute dot product is $\boxed{\tfrac12}$.
